...
public class BookCommands {
    ...
    public String updateBookWithNames(@ShellOption Long bookId, @ShellOption String bookTitle, @ShellOption String authorName, @ShellOption String genreName) {
        Book book = bookService.save(new BookSaveRequest(bookId, bookTitle, authorName, genreName));
        return String.format("Book successfully updated: %s", bookMapper.toDTO(book));
    }
