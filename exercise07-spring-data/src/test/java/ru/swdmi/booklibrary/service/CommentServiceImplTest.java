...
class CommentServiceImplTest {
    ...
    void shouldSaveNewCommentWithBookName() {
        ...
        given(bookRepository.findByTitle("Book name")).willReturn(List.of(existingBook));
        given(commentRepository.save(any(Comment.class))).will(invocation -> invocation.getArgument(0));
    ...
    void shouldDeleteCommentById() {
        ...
        given(commentRepository.getById(anyLong()))
                .will(invocation -> new Comment(invocation.getArgument(0)));
